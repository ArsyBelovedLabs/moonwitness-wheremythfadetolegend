...
const toneClass = {
  red: "border-transparent bg-destructive text-white hover:bg-destructive/90",
  orange: "border-transparent bg-orange-600 text-white hover:bg-orange-700",
  yellow: "border-transparent bg-amber-500 text-black hover:bg-amber-600",
  green: "border-transparent bg-emerald-600 text-white hover:bg-emerald-700",
...
function Badge({ className, variant = "default", tone, asChild = false, ...props }) {
  ...
  return <Comp data-slot="badge" data-variant={variant} className={cn(badgeVariants({ variant }), tone && toneClass[tone], className)} {...props} />
}
